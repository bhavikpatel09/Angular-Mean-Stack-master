...
export class UserService {
  ...
  twitter(email): Observable<any> {
      return this.http.post('/api/twitter', email, this.options);
  }
  facebook(email): Observable<any> {
      return this.http.post('/api/facebook', email, this.options);
  }
